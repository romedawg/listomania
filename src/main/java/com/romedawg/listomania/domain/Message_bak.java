...
public class Message_bak {
    ...
    public Message_bak(Builder builder) {
    ...
    public Message_bak(Person person, String category, String data, String owner, LocalTime dateEntry, boolean active) {
        this.person = person;
    ...
    public static final class Builder {
        ...
        public Message_bak build(){
            return new Message_bak(this);
        }
    }
